...
fn benchmark_euclidean_distance(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            ...
            &(&a, &b),
            |bench, (a, b)| {
                bench.iter(|| scalar::distance::euclidean_distance(black_box(a), black_box(b)))
            },
        );
        ...
        group.bench_with_input(
            ...
            |bench, (a, b)| {
                bench.iter(|| {
                    scalar_unrolled::distance::euclidean_distance(black_box(a), black_box(b))
                })
            },
        );
        ...
        group.bench_with_input(
            ...
            &(&a, &b),
            |bench, (a, b)| {
                bench.iter(|| simd_wide::distance::euclidean_distance(black_box(a), black_box(b)))
            },
        );
        ...
        group.bench_with_input(
            ...
            &(&a, &b),
            |bench, (a, b)| {
                bench.iter(|| simd_std::distance::euclidean_distance(black_box(a), black_box(b)))
            },
        );
    }
...
criterion_group!(benches, benchmark_euclidean_distance);
